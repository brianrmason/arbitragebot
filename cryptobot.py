## This file is the original idea from 2022. It has since been improved and modified 
## to a web app using flask. The newer version can be found in the CryptoBot.py file. 
